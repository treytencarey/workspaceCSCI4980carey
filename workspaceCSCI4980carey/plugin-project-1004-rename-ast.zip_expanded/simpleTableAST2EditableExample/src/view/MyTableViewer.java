...
public class MyTableViewer {
   public final static String ID = "simpletableast2editableexample.partdescriptor.simpleasteditabletable";
   public final static String POPUPMENU = "simpletableast2editableexample.popupmenu.mypopupmenu";
