...
public class MethodOrVariableNameLabelProvider extends StyledCellLabelProvider {
	private Text			searchText;
	private static Color	colorYellow	= Display.getCurrent().getSystemColor(SWT.COLOR_YELLOW);

	public MethodOrVariableNameLabelProvider(final Text searchText) {
	...
	protected String getCellText(ViewerCell cell) {
		...
		String cellText = organizer.getMethodOrVariableName();
		return cellText;
	}
}