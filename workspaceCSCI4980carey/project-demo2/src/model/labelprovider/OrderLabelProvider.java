...
public class OrderLabelProvider extends StyledCellLabelProvider {
	private Text			searchText;
	private static Color	colorYellow	= Display.getCurrent().getSystemColor(SWT.COLOR_YELLOW);

	public OrderLabelProvider(final Text searchText) {
	...
	protected String getCellText(ViewerCell cell) {
		...
		String cellText = String.valueOf(organizer.getOrder());
		return cellText;
	}
}