...
public class ClassOrPackageLabelProvider extends StyledCellLabelProvider {
	private Text			searchText;
	private static Color	colorYellow	= Display.getCurrent().getSystemColor(SWT.COLOR_YELLOW);

	public ClassOrPackageLabelProvider(final Text searchText) {
	...
	protected String getCellText(ViewerCell cell) {
		...
		int classOrPackage = organizer.getClassOrPackage();
		
		String cellText = (classOrPackage == 0) ? "Class" : "Package";
		return cellText;
	}
}