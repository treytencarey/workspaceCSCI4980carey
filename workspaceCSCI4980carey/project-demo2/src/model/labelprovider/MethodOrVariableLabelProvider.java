...
public class MethodOrVariableLabelProvider extends StyledCellLabelProvider {
	private Text			searchText;
	private static Color	colorYellow	= Display.getCurrent().getSystemColor(SWT.COLOR_YELLOW);

	public MethodOrVariableLabelProvider(final Text searchText) {
	...
	protected String getCellText(ViewerCell cell) {
		...
		int methodOrVariable = organizer.getMethodOrVariable();
		
		String cellText = (methodOrVariable == 0) ? "Method" : "Variable";
		return cellText;
	}
}