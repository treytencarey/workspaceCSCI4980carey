...
public class UtilNode {
   ...
   public static void resetPackageNode(GraphNode graphNode, GNode node) {
      ...
      // TODO: Class Exercise
      GLabelProvider prov = new GLabelProvider();
      graphNode.setForegroundColor(prov.getForegroundColour(node));
      graphNode.setBackgroundColor(prov.getBackgroundColour(node));
      graphNode.setBorderColor(prov.getBorderColor(node));
