...
public class DeclarationVisitor extends ASTVisitor {
   ...
   public boolean visit(MethodDeclaration methodDecl) {
      ...
      int methodStartPos = methodDecl.getStartPosition();
      ModelProvider.INSTANCE.addProgramElements(pkgName, className, methodName, isRetVoid, parmSize, methodStartPos);
