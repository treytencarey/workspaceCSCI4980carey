...
public class SimpleZestView {
   ...
   public static final String SIMPLEZESTVIEW_ID = "project1030-zest-type-carey.partdescriptor.simplezestview-type-1030carey";
   public static final String SIMPLEVIEW_ID        = "project1030-zest-type-carey.partdescriptor.simpleview";
   public final static String POPUPMENU_ID = "project1030-zest-type-carey.popupmenu.readshow";
