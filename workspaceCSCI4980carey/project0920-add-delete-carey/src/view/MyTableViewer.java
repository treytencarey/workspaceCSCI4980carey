...
public class MyTableViewer {
   public final static String ID        = "project0920-add-delete-carey.partdescriptor.simpletableaddingdeletingtreytencarey";
   public final static String POPUPMENU = "project0920-add-delete-carey.popupmenu.mypopupmenu";
